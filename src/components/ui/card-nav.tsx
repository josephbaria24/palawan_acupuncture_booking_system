            ...
            >
                <div className="card-nav-top absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] z-[2]">
                    ...
                    <button
                        type="button"
                        onClick={onCtaClick}
                        className="card-nav-cta-button hidden md:inline-flex border-0 rounded-[calc(0.75rem-0.2rem)] px-4 items-center h-full font-bold text-sm cursor-pointer transition-all duration-300 hover:brightness-110 active:scale-95"
                ...
                >
                    {(items || []).slice(0, 3).map((item, idx) => (
                        ...
                        >
                            <div className="nav-card-label font-bold tracking-tight text-[18px] md:text-[20px]">
                                {item.label}
                            </div>
