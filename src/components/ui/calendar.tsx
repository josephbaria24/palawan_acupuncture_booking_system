  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: cn(
          "absolute top-0 inset-x-0 h-(--cell-size) flex items-center justify-center gap-32 pointer-events-none",
          defaultClassNames.nav
        ),
        button_previous: cn(
          buttonVariants({ variant: buttonVariant }),
          "size-(--cell-size) p-0 select-none aria-disabled:opacity-50 rounded-xl pointer-events-auto",
        ...
        caption_label: cn(
          "font-bold select-none text-sm min-w-[120px] text-center",
